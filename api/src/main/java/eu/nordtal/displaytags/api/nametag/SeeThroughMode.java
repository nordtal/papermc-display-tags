 ...
 * is neither - it draws the name <em>twice</em>, once without a depth test in a faint white
...
public enum SeeThroughMode {
    /**
     * The name disappears behind the first block, like a text display with {@code see_through:
     * false}. Written as {@code false} in {@code config.yml}.
     */
    NEVER,

    /**
     * The name is drawn through every block at full opacity, like a text display with
     * {@code see_through: true}. Written as {@code true} in {@code config.yml}.
     */
    ALWAYS,
     ...
     */
    public static SeeThroughMode parse(String value) {
    ...
    /**
     * The value that represents this mode in {@code config.yml}.
     */
